...
#include <map>
#pragma region sheh
#define IGameFramework_Address 0x1B2C0AC //Failed to create the GameFramework Interface!
#define SsystemGlobalEnvironmentAdressRU 0x18F62B0 //ai_compatabilityMode
...
public:
	...
	//	return *(IGame**)0X1B22824;  // atimeout ds:d___   upper ssge   or  Libs/UI/HUDHitIndicatorHor.tif  between ssge and aLibsUiHudhitin ds:d
	//}
};
